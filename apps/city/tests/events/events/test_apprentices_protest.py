...
from apps.city.events.events.apprentices_protest import Event as ApprenticesProtestEvent
from apps.savegame.tests.factories import SavegameFactory


@pytest.mark.django_db
def test_apprentices_protest_event_init():
    """Test ApprenticesProtestEvent initialization and class attributes."""
...
@pytest.mark.django_db
def test_apprentices_protest_event_get_probability_with_population():
...
@pytest.mark.django_db
def test_apprentices_protest_event_get_probability_zero_population():
...
@pytest.mark.django_db
def test_apprentices_protest_event_get_verbose_text():
    ...
    expected_text = 'A blacksmith\'s apprentice refuses to shoe horses "until they apologize for biting."'
    assert verbose_text == expected_text


@pytest.mark.django_db
def test_apprentices_protest_event_get_effects():
...
@pytest.mark.django_db
def test_apprentices_protest_event_process():
    ...
    assert "A blacksmith's apprentice refuses to shoe horses" in result_text
    assert "until they apologize for biting" in result_text
